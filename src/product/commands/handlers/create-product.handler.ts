  ...
  async execute(command: CreateProductCommand) {
    ...
    try {
      ...
      try {
        ...
        this.logger.error(`Error occurred while saving product: ${dbError.message}`);
      ...
      try {
        ...
        this.logger.error(`Error occurred while publishing event: ${eventError.message}`);
        this.logger.error(`Stack trace: ${eventError.stack}`);
        throw new BadRequestException('Failed to publish product creation event');
      }
      ...
      try {
        ...
        this.logger.error(`Error occurred while executing CreateInventoryCommand: ${commandError.message}`);
