...
export class SellerRepository {
  ...
  async upsert(email: string, sellerData: Partial<Seller>): Promise<{ seller: Seller; isNewSeller: boolean }> {
  ...
  async updateAccessToken(sellerId: string, accessToken: string): Promise<void> {
  ...
  async updateBusinessNumberVerification(sellerId: string, businessNumber: string, isVerified: boolean): Promise<Seller> {
